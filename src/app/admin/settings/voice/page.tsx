    ...
    <div className="max-w-xl">
      ...
      <div className="rounded-xl bg-white p-6 shadow-sm border space-y-4">
        ...
        <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-900">
          ...
          <p className="mb-2">
            Amharic ball calls announce the <strong>B-I-N-G-O letter and number</strong> (e.g. G 46). Uses bundled offline audio when available; otherwise Windows speech or espeak-ng.
          </p>
